# Alexander Tobin
**Data Analyst | Data Quality & Validation Specialist**
**Tags:** SQL · Data Validation · KPI Reporting · UAT · Power BI · Excel · Azure · Data Governance
(757) 289-1204 | atobin@alum.utk.edu | Virginia Beach, VA

## Professional Summary
Detail-oriented Data Analyst with 10+ years of experience ensuring data accuracy, reporting integrity, and cross-system reconciliation across enterprise environments. Proven track record validating KPIs, leading UAT efforts, and serving as the primary liaison between business stakeholders and technical teams. Skilled at identifying data discrepancies, driving root-cause resolution, and producing audit-ready documentation that supports governance and compliance requirements. Proficient in SQL, Power BI, and advanced Excel for large-scale data investigation and reporting validation.

## Core Skills
- Data Validation & Reconciliation · Data Quality & Root Cause Analysis
- KPI / Business Metric Validation · UAT (Planning, Execution, Defect Tracking)
- Stakeholder Sign-Off Coordination · Audit-Ready Documentation
- Data Governance Frameworks · SQL / MS SQL Server · Power BI / Tableau
- Advanced Excel (XLOOKUP, INDEX/MATCH, ARRAY) · Microsoft Azure
- Cross-Functional Collaboration · Data Migration & Implementation Support
...
- Bridged business users and technical teams with cross-functional support and training.

### Smartsheet Analyst | IMS, Remote (Contract) | May 2023 – Aug 2023
- Built and validated PMO reporting sheets for an HHS contract; identified data quality gaps and implemented improvements.
